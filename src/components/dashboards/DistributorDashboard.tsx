...
import { Package, CheckCircle, Clock, Scan, Eye, ShoppingCart, TrendingUp, QrCode, Camera, Search } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-white rounded-lg shadow p-6 mb-8">
        <div className="text-center mb-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Product Scanner</h3>
          <p className="text-gray-600">Scan products to view their journey and purchase details</p>
        </div>
